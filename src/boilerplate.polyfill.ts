...
Array.prototype.getByLanguage = function (languageCode: LanguageCode): string {
    ...
    return this.find(translation => languageCode === translation.language)!
        .text;
};
...
SelectQueryBuilder.prototype.paginate = async function (
    ...
    if (!options?.takeAll && pageOptionsDto.limit) {
        this.skip(pageOptionsDto.skip).take(pageOptionsDto.limit);
    }
